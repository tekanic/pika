...
- **Getting started** — [Features](#features), [Design principles](#design-principles), [Installation](#installation), [Requirements](#requirements), [DSL overview](#dsl-overview)
- **Building endpoints** — [Params](#params), [Entities](#entities), [Response control](#response-control), [Error handling](#error-handling), [File uploads](#file-uploads), [Nested objects](#nested-objects)
- **Responses & docs** — [Content negotiation](#content-negotiation), [Streaming and Server-Sent Events](#streaming-and-server-sent-events), [OpenAPI 3.1](#openapi-31)
- **Routing & composition** — [Versioning](#versioning), [Mounting sub-APIs](#mounting-sub-apis)
- **Running in production** — [CORS](#cors), [Observability](#observability), [Concurrency and scaling](#concurrency-and-scaling), [Performance](#performance)
- **Testing & development** — [Testing](#testing), [Development](#development)
- **Companion shards** — [Authentication (`pika-auth`)](#authentication-pika-auth), [Clear ORM integration (`pika-clear`)](#clear-orm-integration-pika-clear)
- **Reference** — [DSL syntax notes](#dsl-syntax-notes), [Migrating from Grape](#migrating-from-grape), [Roadmap](#roadmap)
